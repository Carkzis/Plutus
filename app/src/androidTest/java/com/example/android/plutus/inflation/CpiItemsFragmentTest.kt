...
class CpiItemsFragmentTest {
     ...
     */
    @Test
    fun cpiItemsResults_whenRequestSuccessful_displayCpiItems() = runBlockingTest {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.cpi_items_button)).perform(ViewActions.click())

        Espresso.onView(ViewMatchers.withId(R.id.cpi_items_progress_bar))
        ...
        BaristaVisibilityAssertions.assertNotDisplayed(R.id.cpi_items_progress_bar)
     ...
     */
//    @Test
//    fun cpiItemsResults_whenNoConnectionNoDataInCache_displayErrorMessage() = runBlockingTest {
//
//        // Start on contents screen, as DataBindingIdlingResource.monitorFragment
//        // currently not functioning correctly
//        activityScenario = ActivityScenario.launch(MainActivity::class.java)
...
//        // Click the CPI button
//        onView(withId(R.id.cpi_items_button)).perform(click())
//
//        // This shouldn't be displaying.
//        assertNotExist("January")
//
//        // Ensure the CPI error is showing.
//        onView(withId(R.id.cpi_items_error)).check(matches(isDisplayed()))
//
//        // Ensure the progress bar is no longer showing.
//        assertNotDisplayed(R.id.cpi_items_progress_bar)
//
//    }
